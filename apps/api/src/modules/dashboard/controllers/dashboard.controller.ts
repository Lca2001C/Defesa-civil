...
import { FiltrosDashboardDto, FiltrosTimelineDto } from '../dtos/filtros-dashboard.dto';
...
export class DashboardController {
  ...
  resumo(@Query() filtros: FiltrosDashboardDto, @UsuarioAtual() usuario?: JwtPayload) {
  ...
  timeline(@Query() filtros: FiltrosTimelineDto, @UsuarioAtual() usuario?: JwtPayload) {
  ...
  porRegional(@Query() filtros: FiltrosDashboardDto, @UsuarioAtual() usuario?: JwtPayload) {
  ...
  porFormulario(@Query() filtros: FiltrosDashboardDto, @UsuarioAtual() usuario?: JwtPayload) {
